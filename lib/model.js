...
function _indexAll(db, presave, postsave, callback) {
  ...
  (function(callback) {
    ...
    _transformComps.call(self, presave, {}, function(opts, object, i, cb) {
      ...
      var onResolve = _indexAll.call(opts.model, txn, object, postsaveObj, cb);
...
function _afterCommit(object, callback) {
  ...
  _transformComps.call(self, object, object, function(opts, object, i, cb) {
...
Model.prototype.push = function(root, compName, object, callback) {
  ...
  if (Array.isArray(object)) {
    var _push = Model.prototype.push.bind(this, root, compName);
...
Model.prototype.read = function(idOrObj, callback) {
  ...
  if (!Object.keys(this.compositions)) {
    return this.db.index.read(modelIndex, this.type, id, function(err, obj) {
      if (err) return callback(err);
