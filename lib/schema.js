var SeraphError = require('./error').error;
var CastError = require('./error').castError;


var parseSchema = module.exports = function(schema, model){
  if(typeof schema !== 'object' ) {
    throw new SeraphError('Schema must be an object');
  }
  for(var schemaType in schema){
    parseSchemaType(schemaType, schema[schemaType], model);
  }

  model.fields = Object.keys(schema);
};
