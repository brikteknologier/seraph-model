...
Model.prototype.query = function(query, params, varName, callback) {
...
Model.prototype.where = function(predicate, any, callback) {
  ...
  var query = 'MATCH (node:' + this.type + ') ' +
              'WHERE ' + matchers.join(any ? ' OR ' : ' AND ')

  this.query(query, predicate, callback);
}
