...
var validateAndPrepareWithSchema = require('./schema');
...
function Model(seraphDb, type) {
  ...
  this.on('prepare', function(object, callback) {
    ...
    validateAndPrepareWithSchema(schema, object, callback);
  });

  var nodeIndex, idIndex, schema;
  ...
  Object.defineProperty(Model.prototype, 'schema', {
    ...
    set: function(newSchema) {
      schema = newSchema;
      if (schema) this.keys = Object.keys(schema);
      return schema;
    }
  });
